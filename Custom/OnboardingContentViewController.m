...
static CGFloat const kDefaultBodyFontSize = 21;
...
- (void)generateView
{
    ...
    if (_buttonText)
    {
        ...
        UIImage *bgImage = [UIImage imageNamed:@"toolbar_bkg"];
        [_actionButton setBackgroundImage:bgImage forState:UIControlStateNormal];
