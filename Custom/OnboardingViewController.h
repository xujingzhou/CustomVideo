...
@property (copy, nonatomic) Callback callbackPickPhotos;
@property (copy, nonatomic) Callback callbackPickVideo;
@property (copy, nonatomic) Callback callbackPickMusic;
@property (copy, nonatomic) Callback callbackPickEffect;
@property (copy, nonatomic) Callback callbackPickTextEffect;
@property (copy, nonatomic) Callback callbackPickVideoBorder;
...
// Pick photos/music/video/effect by Johnny Xu
- (void) pickPhotos;
- (void) pickVideo;
- (void) pickMusic;
- (void) pickEffect;
