...
- (void)mergeAndExportVideosAtFileURLs:(NSArray *)fileURLArray
{
    ...
    {
        // Return direct to fix can't export animation effect issues.
        if ([_delegate respondsToSelector:@selector(didRecordingMultiVideosSuccess:)])
        {
            [_delegate didRecordingMultiVideosSuccess:[fileURLArray copy]];
        }
